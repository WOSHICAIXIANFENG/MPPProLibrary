package com.mpp.project.library.util;
...
public class SPUtil {
    ...
    */
    ...
    public static void setStringSetPreferences(Context mContext, String key, Set<String> values) {
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(AppConfig.SHAREDPREFERENCE_NAME, Context.MODE_PRIVATE);
        Editor editor = sharedPreferences.edit();
    ...
    public static Set<String> getStringSetPreferences(Context mContext, String key) {
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(AppConfig.SHAREDPREFERENCE_NAME, Context.MODE_PRIVATE);
...
//    }
     ...
     * @Description: set long value for key
     */
    public static void setIntegerContentPreferences(Context mContext, String key, int value) {
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(AppConfig.SHAREDPREFERENCE_NAME, Context.MODE_PRIVATE);
        Editor editor = sharedPreferences.edit();
     ...
     * @Description: get long value by key
     */
    public static int getIntegerContentPreferences(Context mContext, String key) {
        SharedPreferences sharedPreferences = mContext.getSharedPreferences(AppConfig.SHAREDPREFERENCE_NAME, Context.MODE_PRIVATE);
